...
|---------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| **Hozzászólás színezés**        | saját / rád válaszoló / #akció + avatar fókusz + hozzászólás-lánc kiemelés                                                            | [Telepítés](https://raw.githubusercontent.com/lkristof/userscripts/main/ph-forum-colorize.user.js)             |
| **Link átirányítás**            | PH! lapcsalád linkeket az aktuális oldalra irányítja                                                                                  | [Telepítés](https://raw.githubusercontent.com/lkristof/userscripts/main/ph-forum-link-redirect.user.js)        |
| **Üzenet kiemelés**             | kiemeli az aktuális `#msgXXXX` hozzászólást, törölt hozzászólás esetén a legközelebbit dupla katt a fejlécen kijelöli az hozzászólást | [Telepítés](https://raw.githubusercontent.com/lkristof/userscripts/main/ph-forum-msg-anchor-highlight.user.js) |
