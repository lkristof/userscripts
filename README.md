...
| **Üzenet kiemelés**                 | az URL-ben lévő `#msgXXXX` hozzászóláshoz görget és kiemeli azt; törölt hozzászólás esetén a legközelebbit; dupla katt a fejlécen kijelöli a hozzászólást                     |
